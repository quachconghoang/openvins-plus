...
void TrackTorch::feed_monocular(const CameraData &message, size_t msg_id) {
    printf("TRACKTORCH: feed_monocular \n");
    // Timing information
...
void TrackTorch::perform_detection_monocular(const std::vector<cv::Mat> &img0pyr,
                                             const cv::Mat &mask0, std::vector<cv::KeyPoint> &pts0,
                                             std::vector<size_t> &ids0) {
    printf("TRACKTORCH: perform_detection_monocular \n");
}

void TrackTorch::perform_detection_stereo(const std::vector<cv::Mat> &img0pyr, const std::vector<cv::Mat> &img1pyr,
